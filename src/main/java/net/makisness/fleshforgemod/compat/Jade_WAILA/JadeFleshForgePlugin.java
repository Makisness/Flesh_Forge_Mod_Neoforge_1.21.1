...
public class JadeFleshForgePlugin implements IWailaPlugin {
    ...
    public void register(IWailaCommonRegistration registration) {
          ...
          registration.registerBlockDataProvider(JadeHandlerTestBlock.INSTANCE, TestBlockEntity.class);
    ...
    public void registerClient(IWailaClientRegistration registration) {
          ...
          registration.registerBlockComponent(JadeHandlerTestBlock.INSTANCE, TestBlock.class);
